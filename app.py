...
class ResumeApp:
    ...
    def apply_global_styles(self):
        st.markdown("""
        <style>
      /* Scrollbar Styles with Gradient */
        ::-webkit-scrollbar {
        width: 8px;
        height: 4px;
        }
        ...
        background: linear-gradient(135deg, orange,yellow ); /* Blue to Purple Gradient */
        border-radius: 4px;
        }

      ::-webkit-scrollbar-thumb:hover {
        background: linear-gradient(135deg, #3a00c3, #7a1fc7); /* Darker Gradient on Hover */
        }
...
/* Added CSS for the Smart Resume AI text */
.logo-text {
  text-align: center;
  font-size: 18px;
  margin-top: 20px;
  font-weight: bold;
  color: rgb(44, 143, 255); /* Match the loader ball color */
        ...
        with col1:
           ...
           # Input fields with existing values
            ...
            if not re.fullmatch(r"\d{10}", phone):  
               ...
               st.session_state.form_data['personal_info']['phone'] = phone  
    ...
    def render_about(self):
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'https://avatars.githubusercontent.com/u/197863415?s=400&v=4'}" 
                     alt="Swatalina Palar" 
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://avatars.githubusercontent.com/u/197863415?s=400&v=4';">
                <h2 class="profile-name">Swatalina Palar</h2>
                <p class="profile-title">Final Year CS Student</p>
                <div class="social-links">
                    <a href="https://github.com/swatalinapalar" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/swatalina-palar-b7a41b329/" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto: swatalinapalar2@gmail.com" class="social-link" target="_blank">
                        <i class="fas fa-envelope"></i>
                    </a>
                </div>
                <p class="bio-text">
                    Hi 👋🏻, I'm Swatalina Palar, the creator of Smart Resume AI. I built this platform to make resume building simple, smart, and effective. With AI-powered insights, ATS optimization, and job search assistance, my goal is to help job seekers create standout resumes and land their dream jobs with confidence.
                </p>
            </div>
        """, unsafe_allow_html=True)
